...
::: {#fig-hbv-model .captioned-figure}
<img src="./images/HBV-schem-Shrestha-Solomantine-2008.png" alt="HBV Model" width="1000">
...
discharge_plotly_plot_interactive_fp <- "./images/discharge_plotly_plot.html"
discharge_plotly_plot_static_fp <- "./images/discharge_plotly_plot.png"

discharge_plotly_plot <- OutputTrim %>% plot_ly(x = ~DATE) %>% 
        add_trace(y = ~q, name = 'Modeled',  type = 'scatter', mode = 'lines') %>% 
        add_trace(y = ~WS_3, name = 'Measured',  type = 'scatter', mode = 'lines')

discharge_plotly_plot |> htmlwidgets::saveWidget(discharge_plotly_plot_interactive_fp)
webshot(url = discharge_plotly_plot_interactive_fp,file = discharge_plotly_plot_static_fp,cliprect = "viewport")
```

::: {#fig-discharge-plotly-plot .captioned-figure}
<img src="./images/discharge_plotly_plot.png" alt="Discharge plot" width="1000">

Screenshot of discharge graph made with Plotly. View the **[interactive map here](./images/discharge_plotly_plot.html)**. 
:::
...
```{r}
# define where to save static and interactive maps
snow_model_plot_interactive_fp <- "./images/snow_model_plot.html"
snow_model_plot_static_fp <- "./images/snow_model_plot.png"

#Plot modeled and measured snow
snow_model_plot <- OutputTrimSno %>% plot_ly(x = ~DATE) %>% 
        add_trace(y = ~SWE, name = 'Modeled', type = 'scatter', mode = 'lines') %>% 
        add_trace(y = ~STA2, name = 'Measured', type = 'scatter', mode = 'markers')

snow_model_plot |> htmlwidgets::saveWidget(snow_model_plot_interactive_fp)
webshot(url = snow_model_plot_interactive_fp,file = snow_model_plot_static_fp,cliprect = "viewport")
```

::: {#fig-snow-model-plot .captioned-figure}
<img src="./images/snow_model_plot.png" alt="Model plot" width="1000">

Screenshot of modeled and measured snow data. View the **[interactive map here](./images/snow_model_plot.html)**. 
:::
...
```{r}
# define where to save static and interactive maps
snow_model_plot_nse_interactive_fp <- "./images/snow_model_plot_nse.html"
snow_model_plot_nse_static_fp <- "./images/snow_model_plot_nse.png"
...
snow_model_plot_nse <- OutTrim %>% plot_ly(x = ~DATE) %>% 
        add_trace(y = ~q, name = 'Modeled',  type = 'scatter', mode = 'lines') %>% 
        add_trace(y = ~WS_3, name = 'Measured', type = 'scatter', mode = 'lines') %>% 
        layout(title=paste("NSE: ", round(NSE,2)))

snow_model_plot_nse  |> htmlwidgets::saveWidget(snow_model_plot_nse_interactive_fp)
webshot(url = snow_model_plot_nse_interactive_fp,file = snow_model_plot_nse_static_fp,cliprect = "viewport")
```

::: {#fig-model-plot .captioned-figure}
<img src="./images/snow_model_plot_nse.png" alt="Snow model and NSE plot" width="1000">

Screenshot of modeled and measured snow data and NSE. View the **[interactive map here](./images/snow_model_plot_nse.html)**. 
:::
